...
$query = "SELECT * 
          ...
          YEAR(date) = YEAR(CURRENT_DATE()) ORDER BY `date` DESC, time ASC";
...
<div>
    <ul  class="sub-menu">
        <li class="th-title"><a href="appointments-current-week.php">Week</a></li>
        <li class="th-title"><a href="appointments-current-month.php">Maand</a>&darr;</li>
    </ul>
</div>
